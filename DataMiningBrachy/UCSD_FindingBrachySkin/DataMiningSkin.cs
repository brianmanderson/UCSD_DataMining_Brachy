...
namespace UCSD_FindingBrachySkin
{
    ...
    {
        static List<OutPatient> FindBrachySkinPatients(List<PatientClass> patients)
        {
        ...
        static void Main(string[] args)
        {
            ...
            var cylinderPatients = FindBrachySkinPatients(allPatients);
