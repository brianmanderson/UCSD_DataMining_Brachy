...
namespace DataMiningBrachy
{
    ...
    class DataMiningImaging
    {
        static List<OutPatient> FindImagePatients(List<PatientClass> patients)
        {
        ...
        public static void MainImaging()
        {
            ...
            var cylinderPatients = FindImagePatients(allPatients);
            string outputCsvPath = Path.Combine(dataDirectory, "ImagePatients.csv");
